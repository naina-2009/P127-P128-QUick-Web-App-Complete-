...
function gotResults(error, results)
{
    ...
    {
        console.log(results);
        document.getElementById("drawn_sketch").innerHTML = "Label : " + results[0].label;
